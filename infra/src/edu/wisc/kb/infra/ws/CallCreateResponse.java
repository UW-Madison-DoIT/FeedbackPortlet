...
@XmlRootElement(name = "CallCreateResponse")
public class CallCreateResponse {

	/**
	 * Note that the XmlElement annotation is modified from the output of XJC.
	 * The elements in the infra schema are in the "" (empty string) namespace.
	 */
