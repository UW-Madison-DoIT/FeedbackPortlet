  ...
  <div class='container-fluid'>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-6 general-feedback">
        ...
        <p>Use the form below to ask a question or report a problem. Please note that your feedback is not anonymous. This is the test commit from git to prove that this works.</p>
